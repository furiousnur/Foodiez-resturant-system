...
<html lang="en">
  <head>
    ...
    <title>Welcome to foodiez</title>
    <!-- Bootstrap core CSS -->
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-8 mb-4">
          ...
          <form name="message" id="contactForm" action="store.php" method="post">
            ...
            <div class="control-group form-group">
              <div class="controls">
                ...
                <input type="tel"name="phone" class="form-control phone" id="phone" required data-validation-required-message="Please enter your phone number.">
              </div>
            </div>
            <div class="control-group form-group">
              <div class="controls">
                <label>Email Address:</label>
                <input type="email" name="email" class="form-control email" id="email" required data-validation-required-message="Please enter your email address.">
              </div>
            </div>
            <div class="control-group form-group">
              <div class="controls">
                <label>Message:</label>
                <textarea rows="10" name="msg" cols="100" class="form-control msg" id="message" required data-validation-required-message="Please enter your message" maxlength="999" style="resize:none"></textarea>
              </div>
            </div>
            <div id="success"></div>
